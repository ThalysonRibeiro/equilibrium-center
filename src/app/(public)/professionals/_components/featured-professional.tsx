  ...
  return (
    <section className="mt-12">
      <div className="container mx-auto px-6 space-y-6 flex flex-col items-center">
        <h2 className="text-primary text-2xl text-center mb-2 font-bold">
        ...
        {/* <section className="w-full grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 pb-6"> */}
        <Swiper
        ...
        >
          {featuredProfessional.map(professional => (
            <SwiperSlide key={professional.id}>
              <Card className="relative h-125 overflow-hidden pt-0 hover:border-accent flex flex-col justify-between">
                <CardContent className="p-0">
                  {professional.plan === "PROFESSIONAL" && (
                    <div className="absolute z-[999] top-3 left-3 text-xs text-yellow-950 font-semibold py-1 px-2 bg-yellow-500 w-fit rounded">
                      DESTAQUE
                    </div>
                  )}
